...
#download jira
sudo wget  https://www.atlassian.com/software/stash/downloads/binary/atlassian-bitbucket-5.10.0-x64.bin

#ls -- whether the bin file downloaded or not.
echo'
[ec2-user@ip-172-31-47-93 ~]$ ls
atlassian-bitbucket-5.10.0-x64.bin
'

chmod a+x atlassian-bitbucket-5.10.0-x64.bin

sudo ./atlassian-bitbucket-5.10.0-x64.bin

echo'
[root@ip-172-31-21-34 ~]# sudo ./atlassian-bitbucket-5.10.0-x64.bin
Unpacking JRE ...
Starting Installer ...
...
[/opt/atlassian/bitbucket/5.10.0]
...
Installation Directory: /opt/atlassian/bitbucket/5.10.0
...
Launching Bitbucket ...
Installation of Bitbucket 5.10.0 is complete
Your installation of Bitbucket 5.10.0 is now ready and can be accessed via
your browser.
Bitbucket 5.10.0 can be accessed at http://localhost:7990
Launch Bitbucket 5.10.0 in browser?
Yes [y, Enter], No [n]
y
